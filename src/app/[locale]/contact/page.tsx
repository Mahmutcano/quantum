                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground whitespace-pre-line">{t("address")}</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                ...
                                <a href={`https://wa.me/${t("phone").replace(/[^+\d]/g, "")}`} target="_blank" rel="noopener noreferrer" className="block w-full">
                                    <Button className="flex w-full mt-4 gap-4 cursor-pointer" variant="outline">
                                        <span><Image src="/images/whatsapp.png" alt="whatsapp" width={24} height={24} /></span>
